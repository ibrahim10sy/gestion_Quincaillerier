...
//suppression
if (isset($_GET['ids'])) {
    $db->query('delete from fournisseur where idf=' . $_GET['ids']);
...
<li><a class="active" href="ajouter-client.php"><span>Ajouter Cients</span></a></li>
<li><a href="liste-client.php"><span>Liste Cients</span></a></li>
...
<label class="focus-label"> ID Fournisseurs</label>
</div>
</div>
<div class="col-sm-6 col-md-3">
<div class="form-group form-focus">
<input type="text" class="form-control floating">
<label class="focus-label">Nom Fourisseurs</label>
</div>
</div>
<div class="col-sm-6 col-md-3">
...
<h4 class="modal-title">Supprimer Fournisseurs</h4>
</div>
<form>
<div class="modal-body">
<p>Voulez vous supprimer ce fournisseurs ?</p>
