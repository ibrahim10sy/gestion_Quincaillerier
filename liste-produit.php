...
if (isset($_GET['ids'])) {
    $db->query('delete from stocks where idp=' . $_GET['ids']);
                    ...
                    <ul class="sidebar-ul">
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled" style="display: none;">
                                <li><a class="active" href="ajouter-client.php"><span>Ajouter Clients</span></a></li>
                                <li><a href="liste-client.php"><span>Liste Clients</span></a></li>
                    ...
                    <div class="row filter-row">
                        <div class="col-sm-6 col-md-3">
                            <div class="form-group form-focus">
                                ...
                                <label class="focus-label">ID Produit</label>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-3">
                            <div class="form-group form-focus">
                                ...
                                <table class="table custom-table datatable">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th style="min-width:50px;">Nom Produit</th>
                                            <th style="min-width:50px;">Description</th>
                                            <th style="min-width:50px;">Pric Unitaire</th>
                                            <th style="min-width:50px;">Quantité</th>
                                    ...
                                    <tbody>
                                        ...
                                        while ($ligne = $req->fetch()) {
                                            ...
                                            echo '<td>
            <a href="ajouter-produit.php?idm=' . $ligne['idp'] . '"><i class="fas fa-edit" > </i><a/>
            <a href="liste-produit.php?ids=' . $ligne['idp'] . '"><i class="fas fa-trash alt" > </i><a/>
            </td>';
