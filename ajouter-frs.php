...
if(isset($_POST['enregistrer'])){
    ...
    if (isset($_POST['nomf'],$_POST['prenomf'],$_POST['adressef'],$_POST['telephone'])) {
       ...
       $req = $db->prepare('insert into fournisseur (mclle,nomf,prenomf,adressef,telephone) values (?,?,?,?,?)');
       $req -> bindValue (1,$matricule);
       $req -> bindValue (2,$_POST['nomf']);
       $req -> bindValue (3,$_POST['prenomf']);
       $req -> bindValue (4,$_POST['adressef']);
...
if(isset($_GET['idm'])) {
    ...
    $req = $db ->query('select * from fournisseur where idf=' .$_GET['idm']);
    if($ligne = $req -> fetch()){
        $_POST['idf'] = $ligne['idf'];
...
if(isset($_POST['modifier'])) {
    if(isset($_POST['nomf'],$_POST['prenomf'],$_POST['adressef'],$_POST['telephone']));
       $req = $db ->prepare('update fournisseur set nomf=?,prenomf=?,adressef=?,telephone=? where idf=?');
...
<li class="submenu">
<a href="#"><img src="assets/img/sidebar/icon-2.png" alt="icon"> <span> FProduits</span> <span class="menu-arrow"></span></a>
<ul class="list-unstyled" style="display: none;">
...
<h5 class="text-uppercase mb-0 mt-0 page-title">Ajouter Fournisseurs</h5>
</div>
<div class="col-lg-6 col-md-6 col-sm-6 col-12">
...
<div class="row">
<div class="col-lg-6 col-md-6 col-sm-6 col-12">
<form action="ajouter-frs.php" method="POST">
<div class="form-group">
<label>Nom</label>
<input type="text" class="form-control" name="nomf"  value="<?php if(isset($_POST['nomf'])) echo $_POST['nomf'] ?>">
</div>
<div class="form-group">
<label>Prenom</label>
<input type="text" class="form-control" name="prenomf" value="<?php if(isset($_POST['prenomf'])) echo $_POST['prenomf'] ?>" >
</div>
...
<div class="form-group">
<label>Adresse</label>
<input type="text" class="form-control" name="adressef"  value="<?php if(isset($_POST['adressef'])) echo $_POST['adressef'] ?>" >
</div>
