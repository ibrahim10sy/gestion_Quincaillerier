<?php 
  ...
  $sql="select * from commandes where SID = '{$_GET["id"]}'" ;
  $res=$con->query($sql);
  if($res->num_rows>0){
	  $row=$res->fetch_assoc();
  ...
  $sql="select * from produit where SID='{$_GET["id"]}'";
  $res=$con->query($sql);
  if($res->num_rows>0){
  ...
  class PDF extends FPDF
  {
    function Header(){
      ...
      $this->Cell(50,10,"G-QUINCAILLERIE",0,1);
      $this->SetFont('Arial','',14);
      $this->Cell(50,7,"MALI,",0,1);
      $this->Cell(50,7,"Bamako.",0,1);
      $this->Cell(50,7,"TEL : 00223 82-51-17-23",0,1);
    ...
    function body($info,$products_info){
      ...
      $this->Cell(50,10,"Facture Numero: ",0,1);
      ...
      $this->SetY(55);
      $this->SetX(-60);
      $this->Cell(50,7,"Numero : ".$info["invoice_no"]);
      ...
      $this->SetX(10);
      $this->SetFont('Arial','B',12);
      // $this->Cell(0,9,"Montant en lettres anglais ",0,1);
      $this->SetFont('Arial','',12);
    ...
    function Footer(){
      ...
      $this->SetY(-50);
      $this->SetFont('Arial','B',12);
      $this->Cell(0,10,"DE G-QUINCAILLERIE",0,1,"R");
      $this->Ln(15);
      $this->SetFont('Arial','',12);
