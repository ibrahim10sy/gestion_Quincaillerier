...
if (isset($_POST['enregistrer'])) {
    ...
    if (isset($_POST['nomp'], $_POST['descr'], $_POST['prixunitaire'], $_POST['quantite'])) {
        ...
        $req = $db->prepare('insert into stocks (mclle,nomp,descr,prixunitaire,quantite) values (?,?,?,?,?)');
        $req->bindValue(1, $matricule);
        $req->bindValue(2, $_POST['nomp']);
        $req->bindValue(3, $_POST['descr']);
        $req->bindValue(4, $_POST['prixunitaire']);
        $req->bindValue(5, $_POST['quantite']);
        $req->execute();
...
if (isset($_GET['idm'])) {
    ...
    $req = $db->query('select * from stocks where idp=' . $_GET['idm']);
    if ($ligne = $req->fetch()) {
        $_POST['idp'] = $ligne['idp'];
...
if (isset($_POST['modifier'])) {
    if (isset($_POST['nomp'], $_POST['descr'], $_POST['prixunitaire'], $_POST['quantite']));
    $req = $db->prepare('update stocks set nomp=?,descr=?,prixunitaire=?,quantite=? where idp=?');
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                            <h5 class="text-uppercase mb-0 mt-0 page-title">Ajouter Produit</h5>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                            <ul class="breadcrumb float-right p-0 mb-0">
                                <li class="breadcrumb-item"><a href="accueil.php"><i class="fas fa-home"></i> Dashboard</a></li>
                                <li class="breadcrumb-item"><a href="accueil.php">Produits</a></li>
                                <li class="breadcrumb-item"><span> Tous les produits</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                            <form action="ajouter-produit.php" method="POST">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="nomp" value="<?php if (isset($_POST['nomp'])) echo $_POST['nomp'] ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label>Description</label>
                                                    <input type="text" class="form-control" name="descr" value="<?php if (isset($_POST['descr'])) echo $_POST['descr'] ?>">
                                                </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" name="prixunitaire" value="<?php if (isset($_POST['prixunitaire'])) echo $_POST['prixunitaire'] ?>">
                                            </div>

                                            <div class="form-group">
                                                <label>Quantité</label>
                                                <input type="text" class="form-control" name="quantite" value="<?php if (isset($_POST['quantite'])) echo $_POST['quantite'] ?>">
                                            </div>
