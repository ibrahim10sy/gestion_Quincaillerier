...
<ul class="list-unstyled" style="display: none;">
<li><a class="active" href="invoices.php"><span>Invoices</span></a></li>
...
<h5 class="text-uppercase mb-0 mt-0 page-title">Edit Invoice</h5>
</div>
<div class="col-lg-6 col-md-6 col-sm-6 col-12">
...
<li class="breadcrumb-item"><span>Edit Invoice</span></li>
</ul>
</div>
</div>
</div>
...
<div class="form-group">
<label>Email</label>
<input type="text" class="form-control" value="barrycuda@example.com">
</div>
</div>
<div class="col-sm-6 col-md-3">
<div class="form-group">
...
<textarea class="form-control" placeholder="Teacher Address">5754 Airport Rd, Coosada, AL, 36020</textarea>
</div>
</div>
<div class="col-sm-6 col-md-3">
<div class="form-group">
<label>Billing Address</label>
<textarea class="form-control" placeholder="Billing Address">5754 Airport Rd, Coosada, AL, 36020</textarea>
</div>
</div>
<div class="col-sm-6 col-md-3">
<div class="form-group">
