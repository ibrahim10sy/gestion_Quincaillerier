...
<h5 class="text-uppercase mb-0 mt-0 page-title">Employees</h5>
</div>
<div class="col-lg-6 col-md-6 col-sm-6 col-12">
...
<a href="add-employee.php" class="btn btn-primary btn-rounded float-right"><i class="fas fa-plus"></i> Add Employees</a>
<div class="view-icons">
<a href="all-employees.php" class="grid-view btn btn-link active"><i class="fas fa-th"></i></a>
<a href="employees-list.php" class="list-view btn btn-link"><i class="fas fa-bars"></i></a>
</div>
</div>
</div>
...
<div class="dropdown-menu dropdown-menu-right">
<a class="dropdown-item" href="edit-employee.php"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a>
