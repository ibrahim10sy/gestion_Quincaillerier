...
<ul class="sidebar-ul">
<li>
<a href="inbox.php" class="border-top-0"><i class="fas fa-home back-icon"></i> Back to Inbox</a>
</li>
<li>
...
<button class="btn btn-primary mb-1"><span>Send</span> <i class="fas fa-paper-plane m-l-5"></i></button>
<button class="btn btn-success m-l-5 mb-1" type="button"><span>Draft</span> <i class="far fa-save m-l-5"></i></button>
<button class="btn btn-success m-l-5 mb-1" type="button"><span>Delete</span> <i class="fas fa-trash-alt m-l-5"></i></button>
</div>
</div>
</form>
</div>
