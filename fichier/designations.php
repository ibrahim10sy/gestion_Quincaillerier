...
<li><a class="active" href="designations.php"><span>Designations</span></a></li>
</ul>
</li>
<li>
...
<a href="#" class="btn btn-primary btn-rounded" data-toggle="modal" data-target="#add_designation"><i class="fas fa-plus"></i> Add New Designation</a>
</div>
</div>
<div class="row">
...
<div class="dropdown-menu dropdown-menu-right">
<a class="dropdown-item" href="#" data-toggle="modal" data-target="#edit_designation" title="Edit"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a>
<a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_designation" title="Delete"><i class="fas fa-trash-alt m-r-5"></i> Delete</a>
</div>
</div>
</td>
</tr>
