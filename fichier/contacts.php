...
<li>
<a class="active" href="contacts.php"><span> Contacts</span></a>
</li>
</ul>
</li>
<li>
...
<a href="add-contact.php" class="btn btn-primary btn-block"><i class="fas fa-plus"></i> Add Contact</a>
...
<a href="profile.php" title="John Doe"><img src="assets/img/profile/img-1.jpg" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
</div>
...
<a href="" class="dropdown-toggle action-icon" data-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis-v"></i></a>
<div class="dropdown-menu dropdown-menu-right">
<a class="dropdown-item" href="javascript:void(0)"><i class="fas fa-pencil-alt m-r-5"></i>Edit</a>
<a class="dropdown-item" href="javascript:void(0)"><i class="fas fa-trash-alt m-r-5"></i>Delete</a>
</div>
</li>
</ul>
</div>
...
<div class="contact-cont">
<div class="float-left user-img m-r-10">
<a href="profile.php" title="Richard Miles"><img src="assets/img/profile/img-2.jpg" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
</div>
<div class="contact-info">
...
<div class="contact-cont">
<div class="float-left user-img m-r-10">
<a href="profile.php" title="John Doe"><img src="assets/img/profile/img-3.jpg" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
</div>
<div class="contact-info">
<span class="contact-name text-ellipsis">Ruth C. Gault</span>
 <span class="contact-date">Maths Teacher</span>
...
<div class="contact-cont">
<div class="float-left user-img m-r-10">
<a href="profile.php" title="Richard Miles"><img src="assets/img/profile/img-4.jpg" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
</div>
<div class="contact-info">
<span class="contact-name text-ellipsis">Michael V. Buttars</span>
<span class="contact-date">Science Teacher</span>
...
<div class="contact-cont">
<div class="float-left user-img m-r-10">
<a href="profile.php" title="John Doe"><img src="assets/img/profile/img-5.jpg" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
</div>
<div class="contact-info">
 <span class="contact-name text-ellipsis">Ruth C. Gault</span>
<span class="contact-date">Maths Teacher</span>
...
<div class="contact-cont">
<div class="float-left user-img m-r-10">
<a href="profile.php" title="Richard Miles"><img src="assets/img/profile/img-6.jpg" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
</div>
<div class="contact-info">
<span class="contact-name text-ellipsis">Michael V. Buttars</span>
<span class="contact-date">Science Teacher</span>
...
<div class="contact-cont">
<div class="float-left user-img m-r-10">
<a href="profile.php" title="John Doe"><img src="assets/img/profile/img-7.jpg" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
</div>
 <div class="contact-info">
<span class="contact-name text-ellipsis">Ruth C. Gault</span>
<span class="contact-date">Maths Teacher</span>
...
<div class="contact-cont">
<div class="float-left user-img m-r-10">
<a href="profile.php" title="Richard Miles"><img src="assets/img/profile/img-1.jpg" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
</div>
<div class="contact-info">
<span class="contact-name text-ellipsis">Michael V. Buttars</span>
<span class="contact-date">Science Teacher</span>
...
<div class="contact-cont">
<div class="float-left user-img m-r-10">
<a href="profile.php" title="John Doe"><img src="assets/img/profile/img-2.jpg" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
</div>
<div class="contact-info">
<span class="contact-name text-ellipsis">Ruth C. Gault</span>
<span class="contact-date">Maths Teacher</span>
...
<div class="contact-cont">
<div class="float-left user-img m-r-10">
<a href="profile.php" title="Richard Miles"><img src="assets/img/profile/img-3.jpg" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
</div>
<div class="contact-info">
<span class="contact-name text-ellipsis">Michael V. Buttars</span>
<span class="contact-date">Science Teacher</span>
