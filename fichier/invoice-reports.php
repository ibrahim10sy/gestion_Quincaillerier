...
<li><a class="active" href="invoice-reports.php"> <span>Invoice Report</span> </a></li>
</ul>
</li>
</ul>
</li>
...
<h5 class="text-uppercase mb-0 mt-0 page-title">Invoice Reports</h5>
</div>
<div class="col-lg-6 col-md-6 col-sm-6 col-12">
...
<li class="breadcrumb-item"><span>Invoice Reports</span></li>
</ul>
</div>
</div>
</div>
...
<div class="col-sm-6 col-md-3 select-focus">
...
<div class="dropdown-menu dropdown-menu-right">
<a class="dropdown-item" href="edit-invoice.php"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a>
<a class="dropdown-item" href="invoice-view.php"><i class="fas fa-eye m-r-5"></i> View</a>
<a class="dropdown-item" href="#"><i class="fas fa-file-pdf m-r-5"></i> Download</a>
<a class="dropdown-item" href="#"><i class="fas fa-trash-alt m-r-5"></i> Delete</a>
</div>
</div>
</td>
</tr>
