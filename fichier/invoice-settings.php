...
<h5 class="text-uppercase mb-0 mt-0 page-title">Invoice Settings</h5>
</div>
<div class="col-lg-6 col-md-6 col-sm-6 col-12">
<ul class="breadcrumb float-right p-0 mb-0">
<li class="breadcrumb-item"><a href="accueil.php"><i class="fas fa-home"></i> Home</a></li>
<li class="breadcrumb-item"><a href="#">Settings</a></li>
<li class="breadcrumb-item"><span> Invoice Settings</span></li>
</ul>
</div>
</div>
</div>
...
<input name="website_name" value="INV" class="form-control">
</div>
<div class="form-group">
<div class="row">
...
<div class="col-lg-2 col-md-2 col-12 d-flex align-items-center">
<div class="form-group d-flex align-items-center">
<div class="img-thumbnail float-right"><img src="assets/img/logo.png" alt="" width="100" height="auto">
</div>
</div>
</div>
</div>
