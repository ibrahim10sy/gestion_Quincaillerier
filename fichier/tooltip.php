...
<li><a class="active" href="tooltip.php">Tooltip</a></li>
...
<h5 class="text-uppercase mb-0 mt-0 page-title">Tooltip</h5>
</div>
<div class="col-lg-6 col-md-6 col-sm-6 col-12">
<ul class="breadcrumb float-right p-0 mb-0">
<li class="breadcrumb-item"><a href="accueil.php"><i class="fas fa-home"></i> Home</a></li>
<li class="breadcrumb-item"><a href="#">Elements</a></li>
<li class="breadcrumb-item"><span>>Tooltip</span></li>
</ul>
</div>
</div>
</div>
...
<button class="example-popover btn btn-primary" type="button" data-container="body" data-bs-toggle="tooltip" data-placement="top" title="Popover title">Hover Me</button>
</div>
</div>
</div>
</div>
...
<div class="card-body">
<div class="popover-list">
<button type="button" class="btn btn-primary" data-toggle="tooltip" data-php="true" title="<em>Tooltip</em> <u>with</u> <b>php</b>">
Tooltip with php
</button>
 <button type="button" class="btn btn-primary" data-toggle="tooltip" data-trigger="click" data-php="true" data-placement="bottom" title="<em>Tooltip</em> <u>with</u> <b>php</b>">
Click Me
</button>
</div>
</div>
