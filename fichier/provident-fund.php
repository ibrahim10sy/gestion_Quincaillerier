...
<li><a class="active" href="provident-fund.php"><span>Provident Fund</span></a></li>
...
<li class="breadcrumb-item"><a href="accueil.php">Accounts</a></li>
...
<a href="#" class="btn btn-primary btn-rounded" data-toggle="modal" data-target="#add_pf"><i class="fas fa-plus"></i> Add Provident Fund</a>
</div>
</div>
...
<div class="dropdown-menu dropdown-menu-right">
<a class="dropdown-item" href="#"><i class="far fa-dot-circle text-danger"></i> Pending</a>
...
<div class="dropdown-menu dropdown-menu-right">
<a class="dropdown-item" href="#" data-toggle="modal" data-target="#edit_pf" title="Edit"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a>
<a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_pf" title="Delete"><i class="fas fa-trash-alt m-r-5"></i> Delete</a>
</div>
</div>
</td>
</tr>
