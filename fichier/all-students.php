...
<ul class="list-unstyled" style="display: none;">
<li><a class="active" href="all-students.php"><span>All Students</span></a></li>
...
<li class="breadcrumb-item"><a href="accueil.php">Students</a></li>
...
<a href="add-student.php" class="btn btn-primary btn-rounded float-right"><i class="fas fa-plus"></i> Add Student</a>
<div class="view-icons">
<a href="all-students.php" class="grid-view btn btn-link active"><i class="fas fa-th"></i></a>
...
<div class="dropdown-menu dropdown-menu-right">
<a class="dropdown-item" href="edit-student.php"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a>
