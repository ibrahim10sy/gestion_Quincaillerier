...
<h5 class="text-uppercase mb-0 mt-0 page-title">School Settings</h5>
</div>
<div class="col-lg-6 col-md-6 col-sm-6 col-12">
<ul class="breadcrumb float-right p-0 mb-0">
<li class="breadcrumb-item"><a href="accueil.php"><i class="fas fa-home"></i> Home</a></li>
<li class="breadcrumb-item"><a href="#">Settings</a></li>
<li class="breadcrumb-item"><span> School Settings</span></li>
</ul>
</div>
</div>
</div>
...
<input type="text" class="form-control" value="G-QUINCAILLERIE">
</div>
</div>
<div class="col-sm-6">
<div class="form-group">
<label>Contact Person</label>
<input type="text" class="form-control" value="Daniel Porter">
</div>
</div>
</div>
<div class="row">
...
<div class="form-group">
<label>Address</label>
<textarea class="form-control" placeholder="Address" rows="4">3864 Quiet Valley Lane, Sherman Oaks, CA, 91403</textarea>
</div>
</div>
...
<div class="form-group">
<label>City</label>
<input type="text" class="form-control" value="Sherman Oaks">
</div>
</div>
<div class="col-sm-6 col-md-6 col-lg-6">
<div class="form-group">
<label>Postal Code</label>
<input type="text" class="form-control" value="91403">
</div>
</div>
</div>
<div class="row">
...
<div class="form-group">
<label>Email </label>
<input type="email" class="form-control" value="danielporter@example.com">
</div>
</div>
<div class="col-sm-6">
<div class="form-group">
<label>Phone Number</label>
<input type="text" class="form-control" value="818-978-7102">
</div>
</div>
</div>
<div class="row">
...
<input type="text" class="form-control" value="818-635-5579">
</div>
</div>
<div class="col-sm-6">
<div class="form-group">
