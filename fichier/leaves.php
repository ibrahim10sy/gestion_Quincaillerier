...
<a href="#" class="btn btn-primary btn-rounded float-right" data-toggle="modal" data-target="#add_leave"><i class="fas fa-plus"></i> Add Leave</a>
</div>
</div>
...
<a class="dropdown-item" href="#"><i class="far fa-dot-circle text-info"></i> Pending</a>
<a class="dropdown-item" href="#"><i class="far fa-dot-circle text-success"></i> Approved</a>
<a class="dropdown-item" href="#"><i class="far fa-dot-circle text-danger"></i> Declined</a>
</div>
</div>
</td>
<td class="text-right">
...
<div class="dropdown-menu dropdown-menu-right">
<a class="dropdown-item" href="#" title="Edit" data-toggle="modal" data-target="#edit_leave"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a>
<a class="dropdown-item" href="#" title="Decline" data-toggle="modal" data-target="#delete_approve"><i class="fas fa-trash-alt m-r-5"></i> Delete</a>
</div>
</div>
</td>
</tr>
