...
<li><a class="active" href="departments.php"><span>Departments</span></a></li>
...
<a href="#" class="btn btn-primary btn-rounded" data-toggle="modal" data-target="#add_department"><i class="fas fa-plus"></i> Add New Department</a>
</div>
</div>
...
<div class="dropdown-menu dropdown-menu-right">
<a class="dropdown-item" href="#" data-toggle="modal" data-target="#edit_department" title="Edit"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a>
<a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_department" title="Delete"><i class="fas fa-trash-alt m-r-5"></i> Delete</a>
</div>
</div>
</td>
</tr>
