...
<li><a class="active" href="salary-view.php"><span> Payslip </span></a></li>
</ul>
</li>
<li class="submenu">
...
<h5 class="text-uppercase mb-0 mt-0 page-title">Payslip</h5>
</div>
<div class="col-lg-6 col-md-6 col-sm-6 col-12">
<ul class="breadcrumb float-right p-0 mb-0">
<li class="breadcrumb-item"><a href="accueil.php"><i class="fas fa-home"></i> Home</a></li>
<li class="breadcrumb-item"><a href="#">Payroll</a></li>
<li class="breadcrumb-item"><span> Payslip</span></li>
</ul>
</div>
</div>
</div>
