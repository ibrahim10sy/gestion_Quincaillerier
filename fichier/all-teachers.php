...
<li><a class="active" href="all-teachers.php"><span>All Teachers</span></a></li>
...
<a href="ajouter-client.php" class="btn btn-primary btn-rounded float-right"><i class="fas fa-plus"></i> Add Teacher</a>
<div class="view-icons">
<a href="all-teachers.php" class="grid-view btn btn-link active"><i class="fas fa-th"></i></a>
<a href="liste-client.php" class="list-view btn btn-link"><i class="fas fa-bars"></i></a>
</div>
</div>
</div>
...
<div class="dropdown-menu dropdown-menu-right">
<a class="dropdown-item" href="edit-teacher.php"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a>
