...
<li><a class="active" href="taxes.php"><span>Taxes</span></a></li>
</ul>
</li>
<li class="submenu">
...
<h5 class="text-uppercase mb-0 mt-0 page-title">Taxes</h5>
</div>
<div class="col-lg-6 col-md-6 col-sm-6 col-12">
...
<li class="breadcrumb-item"><span>Taxes</span></li>
</ul>
</div>
</div>
</div>
...
<div class="dropdown-menu dropdown-menu-right">
<a class="dropdown-item" href="#" data-toggle="modal" data-target="#edit_tax" title="Edit"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a>
<a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_tax" title="Delete"><i class="fas fa-trash-alt m-r-5"></i> Delete</a>
</div>
</div>
</td>
</tr>
