...
<h5 class="text-uppercase mb-0 mt-0 page-title">Theme Settings</h5>
</div>
<div class="col-lg-6 col-md-6 col-sm-6 col-12">
<ul class="breadcrumb float-right p-0 mb-0">
<li class="breadcrumb-item"><a href="index.php"><i class="fas fa-home"></i> Home</a></li>
<li class="breadcrumb-item"><a href="#">Settings</a></li>
<li class="breadcrumb-item"><span>Theme Settings</span></li>
</ul>
</div>
</div>
</div>
...
<input class="form-control" name="website_name" value="School-admin">
</div>
<div class="form-group">
<div class="row">
...
<input name="website_name" class="form-control" type="file">
...
<div class="img-thumbnail float-right"><img src="assets/img/logo.png" alt="" width="100" height="auto"></div>
</div>
</div>
</div>
</div>
...
<div class="form-group">
<label>Favicon</label>
<input name="website_name" type="file" class="form-control">
<span class="form-text text-muted">Recommended image size is 16px x 16px</span>
</div>
</div>
<div class="col-lg-2 col-md-2 col-12 d-flex align-items-center">
<div class="form-group d-flex align-items-center">
<div class="settings-image img-thumbnail float-right"><img src="assets/img/logo.png" class="img-fluid" width="100" height="auto" alt=""></div>
</div>
</div>
</div>
</div>
