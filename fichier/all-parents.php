...
<li class="breadcrumb-item"><a href="accueil.php">Parents</a></li>
...
<a href="add-parent.php" class="btn btn-primary btn-rounded float-right"><i class="fas fa-plus"></i> Add Parents</a>
<div class="view-icons">
<a href="all-parents.php" class="grid-view btn btn-link active"><i class="fas fa-th"></i></a>
<a href="parents-list.php" class="list-view btn btn-link"><i class="fas fa-bars"></i></a>
</div>
</div>
</div>
...
<div class="dropdown-menu dropdown-menu-right">
<a class="dropdown-item" href="edit-parent.php"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a>
