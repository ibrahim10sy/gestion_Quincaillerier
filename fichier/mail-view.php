...
<span class="mail-view-title">G-QUINCAILLERIE Bootstrap Admin Template</span>
</div>
</div>
<div class="col-sm-3">
<div class="mail-view-action">
<div class="btn-group">
<button type="button" class="btn btn-white btn-sm" data-toggle="tooltip" title="Delete"> <i class="fas fa-trash-alt"></i></button>
...
<span class="sender-name">John Doe (<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="cca6a3a4a2a6a3a98ca9b4ada1bca0a9e2afa3a1">[email&#160;protected]</a>)</span>
...
<button type="button" class="btn btn-white"><i class="fas fa-trash-alt"></i> Delete</button>
</div>
</div>
</div>
</div>
