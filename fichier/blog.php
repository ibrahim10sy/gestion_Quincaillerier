...
<ul class="list-unstyled" style="display: none;">
<li><a class="active" href="blog.php"><span>Blog</span></a></li>
...
<li class="breadcrumb-item"><a href="accueil.php">Blog</a></li>
...
<a class="btn btn-primary btn-rounded float-right" href="add-blog.php"><i class="fas fa-plus"></i> Add Blog</a>
</div>
</div>
<div class="row">
...
<a href="blog-details.php" class="read-more"><i class="fas fa-long-arrow-alt-right" aria-hidden="true"></i> Read More</a>
